...
jQuery(function ($) {
    ...
    // isotope (guarded: plugin is not shipped on this site)
    var $gallery = null;
    if ($.fn.isotope) {
    ...
    $('.filtering').on('click', 'span', function () {
        ...
        if ($gallery) { $gallery.isotope({filter: filterValue}); }
    ...
    /* ===================================
       ...
       ====================================== */
    if ($.fn.fancybox) {
        $('[data-fancybox]').fancybox({ protect: true, animationEffect: "fade", hash: null });
    }
    ...
    if ($("#personal").length) {
        ...
        personal.typeString('Executive Coach').pauseFor(2200).deleteAll()
            .typeString('Organizational Strategist').pauseFor(2200).deleteAll()
            .typeString('Author and Speaker').pauseFor(2200).deleteAll()
            .typeString('President, Philip Berry Associates').start();
    }
